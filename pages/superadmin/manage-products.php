                                        ...
                                        <div class="product-info">
                                            <?php if ($product['image']): ?>
                                                ...
                                                if (strpos($imageValue, 'http') === 0) {
                                                    ...
                                                    $imageUrl = '/FARMLINK/uploads/products/' . basename($imageValue);
                                                }
                                                ?>
                                    ...
                                    <td>
                                        <div class="farmer-info">
                                            ...
                                            if (!empty($product['farmer_avatar'])) {
                                                if (strpos($product['farmer_avatar'], '/FARMLINK/') === 0) {
                                                    $farmerPicPath = $product['farmer_avatar'];
                                                } elseif (strpos($product['farmer_avatar'], 'uploads/') === 0) {
                                                    $farmerPicPath = '/FARMLINK/' . $product['farmer_avatar'];
                                                } else {
                                                    $farmerPicPath = '/FARMLINK/uploads/profiles/' . basename($product['farmer_avatar']);
                                                }
                                            }
                                            ?>
